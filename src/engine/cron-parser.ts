 ...
 */
function validateRange(value: number, fieldName: keyof CronFields): void {
 ...
 */
function parseValue(value: string, fieldName: keyof CronFields): number | string {
 ...
 * @param expression - The cron expression to parse (e.g., "0 0 * * *")
 * @returns ParsedCronExpression with expanded fields
...
export function parseCronExpression(expression: string): ParsedCronExpression {
  ...
  const fieldNames: (keyof CronFields)[] = [
    'minute',
    'hour',
    'dayOfMonth',
    'month',
